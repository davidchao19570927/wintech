...
class studentApp(tk.Tk):  
    def __init__(self):  
        ...
        self.btn_delete = tk.Button(self,text="Delete", font=("Helvetica", 11), bg="yellow", fg="blue",command=self.delete_student_data)  
    ...
    def delete_student_data(self):  
        ...
        if MsgBox == 'yes':  
           if db_connection.is_connected() == True:  
            ...
            Delete = "delete from student_master where lname='%s'" % (lname) 
            #print(Delete) 
...
# Inserting record into student_master table of student database  
      try:  
         ...
         #rollno = str(self.fetch_max_roll_no())  
         rollno = 2
