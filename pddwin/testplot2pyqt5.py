...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.editName.setGeometry(QtCore.QRect(150, 640, 640, 36))
        self.editName.setObjectName("editName")
        self.label_3 = QtWidgets.QLabel(Dialog)
        self.label_3.setGeometry(QtCore.QRect(120, 650, 25, 15))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.mycombobox_1 = QtWidgets.QComboBox(Dialog)
        self.mycombobox_1.setGeometry(5, 655, 45, 25)
        self.mycombobox_1.setObjectName("mycombobox_1")
        self.mycombobox_1.addItems(['10x', '20x', '30x', '40x', '50x'])
        self.mycombobox_2 = QtWidgets.QComboBox(Dialog)
        self.mycombobox_2.setGeometry(60, 655, 45, 25)
        self.mycombobox_2.setObjectName("mycombobox_2")
        self.mycombobox_2.addItems(['10x', '20x', '30x', '40x', '50x'])
        self.label_28 = QtWidgets.QLabel(Dialog)
        self.label_28.setGeometry(QtCore.QRect(15, 640, 25, 15))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.label_28.setFont(font)
        self.label_28.setObjectName("label_28")
        self.label_29 = QtWidgets.QLabel(Dialog)
        self.label_29.setGeometry(QtCore.QRect(68, 640, 25, 15))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.label_29.setFont(font)
        self.label_29.setObjectName("label_29")
        self.retranslateUi(Dialog)
        self.btnExit.clicked.connect(Dialog.close) # 绑定添加按钮的单击信号
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_28.setText(_translate("Dialog", "Gain1"))
        self.label_29.setText(_translate("Dialog", "Gain2"))
